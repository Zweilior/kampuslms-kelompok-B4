<x-layout title="Daftar Mata Kuliah" active-nav="courses">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-bento-gap-desktop mb-space-lg">
        ...
        <div class="bg-surface-container-low p-space-lg rounded-2xl shadow-md relative overflow-hidden">
            ...
            <div class="mt-space-md flex items-baseline gap-space-xs">
                ...
                <span class="font-display-lg text-display-lg tracking-tight font-bold leading-none">
                    {{ $courses->count() }}
                </span>

                <span class="font-headline-sm text-headline-sm text-on-surface-variant font-medium">
                    Kelas
                </span>
        ...
        <div class="bg-surface-container-low p-space-lg rounded-2xl shadow-md relative overflow-hidden">
            ...
            <div class="mt-space-md flex items-baseline gap-space-xs">
                ...
                <span class="font-display-lg text-display-lg text-primary tracking-tight font-bold leading-none">
                    {{ $courses->pluck('lecturer_id')->unique()->count() }}
                </span>
    ...
    <div class="bg-surface-container-low p-space-sm rounded-2xl flex items-center gap-space-sm shadow-sm mb-bento-gap-desktop">
        ...
        <div class="flex items-center gap-space-xs bg-surface-container px-space-md py-2 rounded-xl flex-1 max-w-xl">
            ...
            <span class="material-symbols-outlined text-outline text-headline-sm">
                search
            </span>
            ...
            <span class="font-label-sm text-label-sm text-outline-variant bg-surface-container-highest px-1.5 py-0.5 rounded">
                ESC
            </span>
        ...
        <div class="flex items-center gap-space-xs ml-auto">
            ...
            <span id="courseCount" class="font-label-lg text-label-lg text-primary">
                {{ $courses->count() }}
            </span>
    ...
    {{-- GRID MATA KULIAH --}}
    <div
        class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-bento-gap-desktop"
        id="courseGrid"
    >
        ...
        @forelse ($courses as $course)
            ...
            <div
                class="course-card bg-surface-container-low hover:bg-surface-container p-space-lg rounded-2xl shadow-md transition-all duration-300 flex flex-col justify-between group relative overflow-hidden"
            ...
            >
                ...
                <div class="flex flex-col">
                    ...
                    <div class="mt-space-md p-space-xs rounded-xl bg-surface-container flex items-center gap-space-xs">
                        ...
                        <div class="flex flex-col min-w-0 flex-1">
                            ...
                            <span class="font-label-md text-label-md truncate">
                                {{ $lecturerName }}
                            </span>
                ...
                <div class="mt-space-md pt-space-sm flex items-center gap-space-xs">
                    ...
                    <a
                        ...
                        class="w-10 py-2 rounded-xl bg-surface-container-high hover:bg-secondary-container text-on-surface font-label-md text-label-md text-center transition-all flex items-center justify-center"
                        title="Edit"
                    >
        ...
        @empty
            ...
            <div class="col-span-full py-space-2xl text-center">
                ...
                <span class="material-symbols-outlined text-headline-lg text-outline">
                    menu_book
                </span>
                ...
                <a
                    ...
                    class="inline-flex items-center gap-space-xs mt-space-md px-space-md py-2.5 rounded-xl bg-primary text-on-primary"
                >
