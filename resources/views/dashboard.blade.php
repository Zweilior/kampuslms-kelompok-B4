<x-layout title="Dashboard - Akademia LMS" active-nav="dashboard">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-bento-gap-desktop mb-space-lg">
        ...
        {{-- Kartu 1: Mata Kuliah --}}
        <div class="bg-surface-container-low p-space-lg rounded-2xl shadow-md relative overflow-hidden transition-all duration-200 hover:bg-surface-container">
            ...
            <div class="mt-space-md flex items-baseline gap-space-xs">
                <span class="font-display-lg text-display-lg tracking-tight font-bold leading-none">{{ $totalCourses ?? 18 }}</span>
        ...
        <div class="bg-surface-container-low p-space-lg rounded-2xl shadow-md relative overflow-hidden transition-all duration-200 hover:bg-surface-container">
            ...
            <div class="mt-space-md flex items-baseline gap-space-xs">
                <span class="font-display-lg text-display-lg tracking-tight font-bold leading-none">{{ $totalLecturers ?? 3 }}</span>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-outline/10">
                    @forelse ($recentCourses as $course)
                        <tr class="hover:bg-surface-container transition-colors">
                            ...
                            <td class="py-2.5 text-center">
                                <span class="px-2 py-0.5 rounded-full font-label-sm text-label-sm {{ $course->status === 'active' ? 'bg-primary/20 text-primary' : 'bg-surface-container-high text-on-surface-variant' }}">
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="py-6 text-center text-on-surface-variant">Belum ada mata kuliah.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-bento-gap-desktop">
        ...
        <div class="bg-surface-container-low p-space-lg rounded-2xl shadow-md">
            ...
            <div class="flex flex-col gap-space-sm">
                <a href="{{ route('courses.index') }}" class="flex items-center gap-3 p-3 rounded-xl bg-surface-container hover:bg-surface-container-high text-on-surface transition-colors">
                ...
                <a href="{{ route('tentang') }}" class="flex items-center gap-3 p-3 rounded-xl bg-surface-container hover:bg-surface-container-high text-on-surface transition-colors">
